# Script: 5_MG_3years_survival.r
# Title: Three year survival analysis of field cohorts
# Manuscript:
...
##
# Inputs: dat.RData
# Outputs: Survival curves and mixed model summaries for multi year survival
##
# Notes:
